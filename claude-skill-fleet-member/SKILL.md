...
| Ask the operator to **decide/act** (blocked) | `NEEDS-INPUT-<NAME>` | Use when you're blocked on a human decision or action. Put the question in plain text too (there is no pop-up for it). |
